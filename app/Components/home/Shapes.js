  ...
  return (
    <div className="absolute left-0 top-0 -z-10 h-full w-full">
      <svg
        width="27"
        height="29"
        className={`absolute ${positions[0]}`}
      ...
      <svg
        width="26"
        height="26"
        className={`absolute ${positions[1]}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="30"
        height="25"
        className={`absolute ${positions[2]}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="15"
        height="23"
        className={`absolute ${positions[3]}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
      ...
      <svg
        width="15"
        height="23"
        className={`absolute ${positions[4]}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
          transform="rotate(30 9.86603 10.13397)"
      ...
      <svg
        width="49"
        height="17"
        className={`absolute ${positions[5]}`}
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      <svg
        width="26"
        height="26"
        className={`absolute ${positions[6]}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="19"
        height="21"
        className={`absolute ${positions[7]}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
      ...
      <svg
        width="30"
        height="25"
        className={`absolute ${positions[8]}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="47"
        height="29"
        className={`absolute ${positions[9]}`}
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      <svg
        width="33"
        height="20"
        className={`absolute ${positions[10]}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
